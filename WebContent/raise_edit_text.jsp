		...
		<div class="contents-inner">
			...
			<div id="">
				<ul>
					...
					<li><a
						href="<%=request.getContextPath() + "/raise_edit_text.jsp"%>"><FONT
							color="#00ffff">本文</FONT></a></li>
					<li><a
						href="<%=request.getContextPath() + "/raise_edit_image.jsp"%>">動画・画像</a></li>
					<li><a href="#">プロフィール</a></li>
				</ul>
			</div>
			<form action="RaiseEditTextServlet" method="POST">
				<table id="">
					<tr>
						<th>本文</th>
						<td><textarea name="text" placeholder="プロジェクトの本文を入力してください"></textarea></td>
					</tr>
				</table>
				<div id="">
					<input type="hidden" name="project_no" value="${ project_no }">
					<input type="hidden" name="fcount" value="b"> <input
